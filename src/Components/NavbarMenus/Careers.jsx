  ...
  return (
    <>
      ...
      {status?
       ...
       <div className="row heading-row"><div className="col heading">Careers</div>
       <hr />
       At RexGalaxy, we recognize that our greatest asset is our people. We invest in continuous learning, provide mentorship programs, and offer a supportive environment to help you reach your fullest potential. Whether you're an experienced professional or a recent graduate, RexGalaxy offers a platform for you to thrive and contribute to groundbreaking projects.
       <NavLink to='/careers' id='know-more-btn' className="btn-row" onClick={scrollToTop()}>
        Know More
       </NavLink>
       </div>
